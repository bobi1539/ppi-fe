...
import { CONSTANT_PAGE_SIZE_VALUE, ICON_DELETE, ICON_EDIT, ICON_RESTORE, ICON_UNLOCK, TEXT_COLOR_DELETE, TEXT_COLOR_EDIT, TEXT_COLOR_RESTORE, TEXT_DELETE, TEXT_EDIT, TEXT_RESTORE } from "@/app/constants/constant";
...
export default function UserData() {
  ...
  const [userIdChangePassword, setUserIdChangePassword] = useState<number>(0);
  ...
  const handleChangePasswordUser = (id: number, username: string): void => {
    setUserIdChangePassword(id);
    setUsernameChangePassword(username);
    setIsModalChangePasswordOpen(!isModalChangePasswordOpen);
  };
