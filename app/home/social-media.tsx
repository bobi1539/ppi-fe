  ...
  return (
    <section>
      <div className=" bg-white px-16 py-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-4 px-6 md:grid-cols-2 md:gap-8 md:px-8 md:divide-x-4 md:divide-secondary-700">
          <div className="flex flex-col max-w-xl text-black md:col-span-1 text-center md:text-left">
            ...
            <div className="flex gap-4 mt-4 mx-auto md:mx-0">
              <a href="https://www.instagram.com/ppiwarwick/" target="_blank" className="p-1 font-semibold inline-flex items-center space-x-2 rounded">
                <svg width="40px" height="40px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#6d28d9">
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <title>instagram [#167]</title> <desc>Created with Sketch.</desc> <defs> </defs>
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="Dribbble-Light-Preview" transform="translate(-340.000000, -7439.000000)" fill="#6d28d9">
              ...
              <a href="https://www.linkedin.com/company/ppi-warwick/" target="_blank" className="p-1 font-semibold inline-flex items-center space-x-2 rounded">
                <svg width="35px" height="35px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000">
                  ...
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <title>linkedin [#161]</title> <desc>Created with Sketch.</desc> <defs> </defs>
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -7479.000000)" fill="#6d28d9">
                        <g id="icons" transform="translate(56.000000, 160.000000)">
              ...
              <a href="https://www.youtube.com/@ppiwarwick2502" target="_blank" className="p-1 font-semibold inline-flex items-center space-x-2 rounded">
                <svg width="45px" height="45px" viewBox="0 -3 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000">
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="Dribbble-Light-Preview" transform="translate(-300.000000, -7442.000000)" fill="#6d28d9 ">
                        <g id="icons" transform="translate(56.000000, 160.000000)">
            ...
            <div className="hidden p-0 md:flex h-full justify-end items-end -mr-8 -mb-6">
              <svg width="100px" height="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(1, 0, 0, -1, 0, 0)">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                  <path d="M7 17L17 7M17 7H8M17 7V16" stroke="#6d28d9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
              </svg>
            </div>
          </div>
          <div className="md:pl-8 flex justify-center items-center">
            <img width="240px" src="https://ppiwarwick.org/image/ppiwarwick_qr.png" />
          </div>
        </div>
      </div>
    </section>
