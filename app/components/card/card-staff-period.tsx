...
export default function CardStaffPeriod(props: Readonly<CardStaffPeriodProps>) {
  return (
    <div className={`w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)] flex flex-col bg-white items-center p-6 border border-gray-200 shadow rounded-lg relative cursor-pointer transform transition-transform duration-300 hover:scale-110 hover:shadow-xl`}>
