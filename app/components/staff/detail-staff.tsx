  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      <div className="flex flex-col items-center border border-gray-200 shadow rounded-lg p-6 hover:bg-gray-100">
        <Image src={fileDownload(DIRECTORY_STAFF, props.staff?.photo ?? "")} alt={props.staff?.name ?? ""} width={500} height={500} priority className="w-40 h-40 rounded-full border-4 border-gray-200 object-cover" />
